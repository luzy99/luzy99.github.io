(function(){function o(){return Array.prototype.slice.call(document.querySelectorAll.apply(document,arguments))}if(o(".columns .column-right").length&&o(".columns .column-right-shadow").length&&!o(".columns .column-right-shadow")[0].children.length){for(const t of o(".columns .column-right")[0].children){o(".columns .column-right-shadow")[0].append(t.cloneNode(true))}}o("body > .navbar, body > .section, body > .footer").forEach(o=>{o.style.transition="0s";o.style.opacity="0"});document.querySelector("body > .navbar").style.transform="translateY(-100px)";[".column-main > .card, .column-main > .pagination, .column-main > .post-navigation",".column-left > .card, .column-right-shadow > .card",".column-right > .card"].forEach(t=>{o(t).forEach(o=>{o.style.transition="0s";o.style.opacity="0";o.style.transform="scale(0.8)";o.style.transformOrigin="center top"})});setTimeout(()=>{o("body > .navbar, body > .section, body > .footer").forEach(o=>{o.style.opacity="1";o.style.transition="opacity 0.3s ease-out, transform 0.3s ease-out"});document.querySelector("body > .navbar").style.transform="translateY(0)";[".column-main > .card, .column-main > .pagination, .column-main > .post-navigation",".column-left > .card, .column-right-shadow > .card",".column-right > .card"].forEach(t=>{let n=1;o(t).forEach(o=>{setTimeout(()=>{o.style.opacity="1";o.style.transform="";o.style.transition="opacity 0.3s ease-out, transform 0.3s ease-out"},n*100);n++})})})})();$(document).ready(()=>{const e=$("#back-to-top");const t=$("footer.footer");const n=$(".column-main");const o=$(".column-left");const s=$(".column-right");let i=0;const c=20;const l=20;let r=null;const a={base:{classname:"card has-text-centered",left:"",width:64,bottom:l}};a["desktop-hidden"]=Object.assign({},a.base,{classname:a.base.classname+" rise-up"});a["desktop-visible"]=Object.assign({},a["desktop-hidden"],{classname:a["desktop-hidden"].classname+" fade-in"});a["desktop-dock"]=Object.assign({},a["desktop-visible"],{classname:a["desktop-visible"].classname+" fade-in is-rounded",width:40});a["mobile-hidden"]=Object.assign({},a.base,{classname:a.base.classname+" fade-in",right:c});a["mobile-visible"]=Object.assign({},a["mobile-hidden"],{classname:a["mobile-hidden"].classname+" rise-up"});function d(e,t){return![].concat(Object.keys(e),Object.keys(t)).some(n=>{return!Object.prototype.hasOwnProperty.call(e,n)||!Object.prototype.hasOwnProperty.call(t,n)||t[n]!==e[n]})}function u(t){if(r!==null&&d(r,t)){return}e.attr("class",t.classname);for(const n in t){if(n==="classname"){continue}e.css(n,t[n])}r=t}function f(){return window.innerWidth>=1078}function b(){return window.innerWidth>=768&&!f()}function h(){return $(window).scrollTop()<i&&$(window).scrollTop()>0}function m(){return o.length>0}function p(){return s.length>0}function w(){if(!p()){return 0}return Math.max.apply(null,s.find(".widget").map(function(){return $(this).offset().top+$(this).outerHeight(true)}))}function k(){return $(window).scrollTop()}function g(){return $(window).scrollTop()+$(window).height()}function O(){return e.outerWidth(true)}function j(){return e.outerHeight(true)}function y(){i=$(window).scrollTop()}function v(){if(f()||b()&&!m()&&p()){let e;const o=(n.outerWidth()-n.width())/2;const s=$(window).width()-O()-c;const i=t.offset().top+j()/2+l;if(k()===0||g()<w()+o+j()){e=a["desktop-hidden"]}else if(g()<i){e=a["desktop-visible"]}else{e=Object.assign({},a["desktop-dock"],{bottom:g()-i+l})}const r=n.offset().left+n.outerWidth()+o;e=Object.assign({},e,{left:Math.min(r,s)});u(e)}else{if(!h()){u(a["mobile-hidden"])}else{u(a["mobile-visible"])}y()}}v();$(window).resize(v);$(window).scroll(v);$("#back-to-top").on("click",()=>{$("body, html").animate({scrollTop:0},400)})});(function(i,e,t,n){i('.article img:not(".not-gallery-item")').each(function(){if(i(this).parent("a").length===0){i(this).wrap('<a class="gallery-item" href="'+i(this).attr("src")+'"></a>');if(this.alt){i(this).after('<p class="has-text-centered is-size-6 caption">'+this.alt+"</p>")}}});if(typeof i.fn.lightGallery==="function"){i(".article").lightGallery({selector:".gallery-item"})}if(typeof i.fn.justifiedGallery==="function"){if(i(".justified-gallery > p > .gallery-item").length){i(".justified-gallery > p > .gallery-item").unwrap()}i(".justified-gallery").justifiedGallery()}if(!i(".columns .column-right-shadow").children().length){i(".columns .column-right-shadow").append(i(".columns .column-right").children().clone())}if(typeof e==="function"){i(".article-meta time").each(function(){i(this).text(e(i(this).attr("datetime")).fromNow())})}i(".article > .content > table").each(function(){if(i(this).width()>i(this).parent().width()){i(this).wrap('<div class="table-overflow"></div>')}});function a(){const e=i(".navbar-main .navbar-start").outerWidth()+i(".navbar-main .navbar-end").outerWidth();if(i(document).outerWidth()<e){i(".navbar-main .navbar-menu").addClass("justify-content-start")}else{i(".navbar-main .navbar-menu").removeClass("justify-content-start")}}a();i(window).resize(a);function l(e,t){const n=i(e).find(".fold i");!t?i(e).removeClass("folded"):i(e).addClass("folded");!t?n.removeClass("fa-angle-right"):n.removeClass("fa-angle-down");!t?n.addClass("fa-angle-down"):n.addClass("fa-angle-right")}function s(i){return'<span class="fold">'+(i==="unfolded"?'<i class="fas fa-angle-down"></i>':'<i class="fas fa-angle-right"></i>')+"</span>"}i("figure.highlight table").wrap('<div class="highlight-body">');if(typeof n!=="undefined"&&typeof n.article!=="undefined"&&typeof n.article.highlight!=="undefined"){i("figure.highlight").addClass("hljs");i("figure.highlight .code .line span").each(function(){const e=i(this).attr("class").split(/\s+/);if(e.length===1){i(this).addClass("hljs-"+e[0]);i(this).removeClass(e[0])}});const e=n.article.highlight.clipboard;const a=n.article.highlight.fold.trim();i("figure.highlight").each(function(){if(i(this).find("figcaption").length){i(this).find("figcaption").addClass("level is-mobile");i(this).find("figcaption").append('<div class="level-left">');i(this).find("figcaption").append('<div class="level-right">');i(this).find("figcaption div.level-left").append(i(this).find("figcaption").find("span"));i(this).find("figcaption div.level-right").append(i(this).find("figcaption").find("a"))}else{if(e||a){i(this).prepend('<figcaption class="level is-mobile"><div class="level-left"></div><div class="level-right"></div></figcaption>')}}});if(typeof t!=="undefined"&&e){i("figure.highlight").each(function(){const e="code-"+Date.now()+(Math.random()*1e3|0);const t='<a href="javascript:;" class="copy" title="Copy" data-clipboard-target="#'+e+' .code"><i class="fas fa-copy"></i></a>';i(this).attr("id",e);i(this).find("figcaption div.level-right").append(t)});new t(".highlight .copy")}if(a){i("figure.highlight").each(function(){if(i(this).find("figcaption").find("span").length>0){const e=i(this).find("figcaption").find("span");if(e[0].innerText.indexOf(">folded")>-1){e[0].innerText=e[0].innerText.replace(">folded","");i(this).find("figcaption div.level-left").prepend(s("folded"));l(this,true);return}}i(this).find("figcaption div.level-left").prepend(s(a));l(this,a==="folded")});i("figure.highlight figcaption .fold").click(function(){const e=i(this).closest("figure.highlight");l(e.eq(0),!e.hasClass("folded"))})}}const f=i("#toc");if(f.length>0){const e=i("<div>");e.attr("id","toc-mask");i("body").append(e);function o(){f.toggleClass("is-active");e.toggleClass("is-active")}f.on("click",o);e.on("click",o);i(".navbar-main .catalogue").on("click",o)}function r(i,e,t){try{e=new URL(e).hostname}catch(i){}if(!e)return false;let n;try{n=new URL(i,"http://"+e)}catch(i){return false}if(n.origin==="null")return false;const a=n.hostname;if(t){t=Array.isArray(t)?t:[t];if(t&&t.length){for(const i of t){if(a===i)return false}}}if(a!==e)return true;return false}if(typeof n!=="undefined"&&typeof n.site.url!=="undefined"&&typeof n.site.external_link!=="undefined"&&n.site.external_link.enable){i(".article .content a").filter((e,t)=>{return t.href&&!i(t).attr("href").startsWith("#")&&t.classList.length===0&&r(t.href,n.site.url,n.site.external_link.exclude)}).each((i,e)=>{e.relList.add("noopener");e.target="_blank"})}})(jQuery,window.moment,window.ClipboardJS,window.IcarusThemeSettings);var config=window.IcarusThemeSettings;if(typeof config!=="undefined"&&typeof config.busuanzi_site_offset!=="undefined"&&config.busuanzi==true){$(document).ready(function(){var i=setInterval(t,100);var e=parseInt(config.busuanzi_site_offset);function t(){if($("#busuanzi_container_site_uv").css("display")!="none"&&parseInt($("#busuanzi_value_site_uv").html())>0){clearInterval(i);$("#busuanzi_value_site_uv").html(parseInt($("#busuanzi_value_site_uv").html())+e)}}})}/**
